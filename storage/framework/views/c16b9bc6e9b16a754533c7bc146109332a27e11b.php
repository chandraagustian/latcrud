...
<link rel="stylesheet" href="<?php echo e(URL::asset('css/bootstrap/bootstrap.css')); ?> "/>
<link rel="stylesheet" href="<?php echo e(URL::asset('css/bootstrap/bootstrap.min.css')); ?> "/>
...
<!-- <img src="<?php echo e(asset('img')); ?> -->
     <?php $__currentLoopData = $Pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
     <tr>
       <td><?php echo e($value->deskripsi); ?></td>  
      
       <td><?php echo e($value->foto); ?></td>         
...
<!-- <script src="https://unpkg.com/masonry-layout@4.1/dist/masonry.pkgd.min.js"></script> -->
 ...
 <!-- <script src="<?php echo e(URL::asset('js/bootstrap/bootstrap.js')); ?>"></script> -->
