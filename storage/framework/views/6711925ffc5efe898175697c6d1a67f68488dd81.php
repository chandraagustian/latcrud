...
<?php echo e(Form::open(array('route' => 'Page.store', 'class' => 'form',  'files'=>true, 'enctype' => 'multipart/form-data','class'=>'form-horizontal'))); ?>


<!-- <?php echo Form::open(['route' => 'Page.store','enctype' => 'multipart/form-data','class' => 'form-horizontal',  'files'=>true]); ?> -->
...
<?php echo Form::close(); ?>
 ...
 <!-- <li><?php echo link_to(route('Dynamic.index'), "Article"); ?></li>  -->
